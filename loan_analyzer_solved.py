...
def calculate_present_value(future_val, rmonths, annual_discount_rate):
    pvex = (future_val / (1+annual_discount_rate)/12)**rmonths
...
pvexnew = calculate_present_value(future_val, rmonths, annual_discount_rate)
print(f"the present value of the loan is {pvexnew}")

# @TODO: Use the function to calculate the present value of the new loan given below.
#    Use an `annual_discount_rate` of 0.2 for this new loan calculation.

print(f"The present value with 0.2% interest is {pvexnew}")
